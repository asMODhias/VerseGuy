...
fn test_create_get_delete_org() {
    ...
    match svc.create_organization(org.name.clone(), org.tag.clone(), org.description.clone(), org.owner_id.clone()) {
        Ok(_) => {},
    ...
    let org2 = match svc.create_organization("Org2".into(), "O2".into(), "desc2".into(), "owner2".into()) {
        Ok(o) => o,
        Err(e) => panic!("create_organization failed: {}", e),
    };
