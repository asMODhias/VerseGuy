...
- `startup.md` — Startup sequence, first-run logic, and timings.
- `security.md` — Capability system, signing, audit logging, and compliance summary.
- `copilot_rules.md` — Required Copilot behavior and development rules.

Refer to `../VERSE_GUY_V2_ULTIMATE_SPECIFICATION.md` for full authoritative details.